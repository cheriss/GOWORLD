                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="judul text-center">
                            <h1>Hotel</h1>
                            <h4 class="caption">Berbagai hotel berdasarkan area</h4>
                        </div>
                    </div>
                    ...
                    while ($row = mysqli_fetch_array($daftarhotel)) { ?>
                        <div class="col-lg-4 col-sm-6 mt-30">
                            <figure class="figure">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="img/<?php echo $row['hotelFoto']; ?>" alt="Card image cap">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            ...
                                            <?php echo $row['hotelAlamat']; ?><br><br>
                                            <?php echo $row['areaNama']; ?> - <?php echo $row['kabupatenNama'] ?>
                                        </p>
                                    </div>
                                </div>
                            </figure>
                    ...
                    <!-- <figure class="figure">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="img/<?php echo $row['hotelFoto']; ?>" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
                                <div class="card-img-overlay">

                                    <figcaption class="figure-caption-lg"><?php echo $row['hotelNama']; ?></figcaption>
                                </div>
                            </div>
                        </figure> -->
