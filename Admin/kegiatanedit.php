...
<?php
    ...
    {  
        ...
        if(empty($nama))
        {
            mysqli_query($connection, "update kegiatan set kegiatanNama = '$namakegiatan', kegiatanLokasi = '$lokasikegiatan',
            kegiatanTanggal = '$tanggalkegiatan', areaID = '$kodearea'
            where kegiatanID = '$kodekegiatan'");
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "PNG") or ($ekstensifile == "png"))
        {
            ...
            mysqli_query($connection, "update kegiatan set kegiatanNama = '$namakegiatan', kegiatanLokasi = '$lokasikegiatan',
            kegiatanTanggal = '$tanggalkegiatan', areaID = '$kodearea', kegiatanFoto = '$nama'
            where kegiatanID = '$kodekegiatan'");
        }
    ...
    $kodekegiatan = $_GET["ubah"];
    //memanggil file restoran
    $editkegiatan = mysqli_query($connection, "select * from kegiatan 
    where kegiatanID = '$kodekegiatan'");
    $rowedit = mysqli_fetch_array($editkegiatan);

    //MEMUNCULKAN NAMA AREA DI SEARCH
    $editarea = mysqli_query($connection, "select * from kegiatan, area
    where kegiatanID = '$kodekegiatan' and kegiatan.areaID = area.areaID");
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid" style="margin-top: 15px;">
                <div class="container">
                    <h1 class="display-4">Edit Kegiatan Wisata</h1>
                </div>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputkode" placeholder="Kode Kegiatan" maxlength="4" value="<?php echo $rowedit["kegiatanID"]?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputnama" placeholder="Nama Kegiatan" value="<?php echo $rowedit["kegiatanNama"]?>">
                    </div>
                </div>  
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputlokasi" placeholder="Lokasi Kegiatan" value="<?php echo $rowedit["kegiatanLokasi"]?>">
                    </div>
                </div> 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputtanggal" placeholder="Tanggal Kegiatan" value="<?php echo $rowedit["kegiatanTanggal"]?>">
                    </div>
                </div> 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <img src="img/<?php echo $rowedit['kegiatanFoto']?>" style="width: 200px;
                        height: 100px;">
