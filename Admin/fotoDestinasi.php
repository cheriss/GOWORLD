...
<?php
    ...
    {  
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "PNG") or ($ekstensifile == "png"))
        {
            ...
            mysqli_query($connection, "insert into fotodestinasi value ('$kodefoto', '$namafoto', '$kodedestinasi',
            '$nama')");
        }
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputkode" placeholder="Kode Foto" maxlength="4">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputnama" placeholder="Nama Foto">
                    </div>
                </div>  

                <div class="form-group row">
                    <label for="namadestinasi" class="col-sm-2 col-form-label">Daftar Destinasi</label>
                    <div class="col-sm-10">
