...
<?php
    ...
    {  
        ...
        if(empty($nama))
        {
            ...
            hotelKeterangan = '$kethotel', areaID = '$kodearea'
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "PNG") or ($ekstensifile == "png"))
        {
            ...
            mysqli_query($connection, "update hotel set hotelNama = '$namahotel', hotelAlamat = '$alamathotel',
            hotelKeterangan = '$kethotel', hotelFoto = '$nama', areaID = '$kodearea'
            where hotelID = '$kodehotel'");
        }
    ...
    $kodehotel = $_GET["ubah"];
    //memanggil file hotel
    $edithotel = mysqli_query($connection, "select * from hotel 
    where hotelID = '$kodehotel'");
    $rowedit = mysqli_fetch_array($edithotel);

    //MEMUNCULKAN NAMA AREA DI SEARCH
    $editarea = mysqli_query($connection, "select * from hotel, area, kabupaten
    where hotelID = '$kodehotel' and hotel.areaID = area.areaID
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputkode" placeholder="Kode Hotel" maxlength="4" value="<?php echo $rowedit["hotelID"]?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputnama" placeholder="Nama Hotel" value="<?php echo $rowedit["hotelNama"]?>">
                    </div>
                </div>  
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="namaHotel"
                        name="inputalamat" placeholder="Alamat Hotel" value="<?php echo $rowedit["hotelAlamat"]?>">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control" id="ketHotel"
                        name="inputket" placeholder="Keterangan Hotel" value="<?php echo $rowedit["hotelKeterangan"]?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <img src="img/<?php echo $rowedit['hotelFoto']?>" style="width: 200px;
                        height: 100px;">
