...
<?php
    ...
    if(isset($_POST['ubah']))
    {
        ...
        mysqli_query($connection,"update kategori set kategoriNama = '$kategoriNama', kategoriKeterangan = '$kategoriKet',
        kategoriReferensi = '$kategoriRef'
    ...
    $kodekategori = $_GET["ubah"]; //ubah itu dari variabel yang ada di destinasi.php seblumnya
        ...
        <div class="col-sm-10">
            ...
            <form method="POST"> <!--method untuk mengirim isi input ke database-->
                <div class="form-group row">
                    ...
                    name="inputKode" maxlength="4" value="<?php echo $rowedit["kategoriID"]?>" readonly> <!--maxlength=membatasi isi, required=hrs diiisi-->
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    name="inputNama" value="<?php echo $rowedit["kategoriNama"]?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    name="inputKet" value="<?php echo $rowedit["kategoriKeterangan"]?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    name="inputRef" value="<?php echo $rowedit["kategoriReferensi"]?>">
                    </div>
                </div>
