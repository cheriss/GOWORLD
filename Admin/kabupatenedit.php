...
<?php
    ...
    {  
        ...
        if(empty($nama))
        {
            mysqli_query($connection, "update kabupaten set kabupatenNama = '$namakabupaten', kabupatenAlamat = '$alamatkabupaten', 
            kabupatenKet = '$ketkabupaten', kabupatenFotoiconket = '$ketfoto'
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "PNG") or ($ekstensifile == "png"))
        {
            ...
            mysqli_query($connection, "update kabupaten set kabupatenNama = '$namakabupaten', kabupatenAlamat = '$alamatkabupaten', 
            kabupatenKet = '$ketkabupaten', kabupatenFotoicon = '$nama', kabupatenFotoiconket = '$ketfoto'
            where kabupatenKode = '$kodekabupaten'");
        }
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputkode" placeholder="Kode Kabupaten" value="<?php echo $rowedit["kabupatenKode"]?>" readonly >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputnama" placeholder="Nama Kabupaten" value="<?php echo $rowedit["kabupatenNama"]?>">
                    </div>
                </div>  
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="namakabupaten"
                        name="inputalamat" placeholder="Alamat Kabupaten" value="<?php echo $rowedit["kabupatenAlamat"]?>">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control" id="ketkabupaten"
                        name="inputket" placeholder="Keterangan Kabupaten" value="<?php echo $rowedit["kabupatenKet"]?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <img src="img/<?php echo $rowedit['kabupatenFotoicon']?>" style="width: 200px;
                        height: 100px;">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control" id="ketfoto"
                        name="ketfotoicon" placeholder="Keterangan Foto" value="<?php echo $rowedit["kabupatenFotoiconket"]?>">
                    </div>
                </div>
