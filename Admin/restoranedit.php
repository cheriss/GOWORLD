...
<?php
    ...
    if(isset($_POST['ubah']))
    {
        ...
        $restoranKet = $_POST['inputKet'];
        $destinasiArea = $_POST['kodearea'];

        mysqli_query($connection,"update restoran set restoranNama = '$restoranNama', 
        restoranAlamat = '$restoranAlamat', restoranKeterangan = '$restoranKet', areaID = '$destinasiArea'
    ...
    //memanggil file restoran
    $editrestoran = mysqli_query($connection, "select * from restoran 
    where restoranID = '$koderestoran'");
    $rowedit = mysqli_fetch_array($editrestoran);

    //MEMUNCULKAN NAMA AREA DI SEARCH
    $editarea = mysqli_query($connection, "select * from restoran, area
    where restoranID = '$koderestoran' and restoran.areaID = area.areaID");
        ...
        <div class="col-sm-10">
            ...
            <form method="POST"> <!--method untuk mengirim isi input ke database-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodeRestoran" placeholder="Kode Restoran"
                    name="inputKode" maxlength="4" value="<?php echo $rowedit["restoranID"]?>" readonly> <!--maxlength=membatasi isi, required=hrs diiisi-->
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="namaRestoran" placeholder="Nama Restoran"
                    name="inputNama" value="<?php echo $rowedit["restoranNama"]?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="destinasiAlamat" placeholder="Alamat Restoran"
                    name="inputAlamat" value="<?php echo $rowedit["restoranAlamat"]?>">
                    </div>
                </div>

                <!--KETERANGAN RESTORAN-->
                <div class="form-group row">
                    <label for="kategoriResto" class="col-sm-2 col-form-label">Keterangan</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="kategoriResto" placeholder="Keterangan Restoran"
                    name="inputKet" value="<?php echo $rowedit["restoranKeterangan"]?>">
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Daftar Restoran Wisata</h1>
