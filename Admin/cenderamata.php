...
<?php
    ...
    {  
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "PNG") or ($ekstensifile == "png"))
        {
            ...
            mysqli_query($connection, "insert into cenderamata value ('$kodecinderamata', '$namacinderamata', '$alamatcinderamata',
            '$nama', '$kodearea')");
        }
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid" style="margin-top: 15px;">
                <div class="container">
                    <h1 class="display-4">Input Toko Cinderamata</h1>
                </div>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputkode" placeholder="Kode Toko" maxlength="4">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputnama" placeholder="Nama Toko">
                    </div>
                </div>  
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        name="inputalamat" placeholder="Alamat Toko">
                    </div>
                </div> 
